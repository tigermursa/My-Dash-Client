...
const Settings = () => {
  ...
  return (
    <div className=" bg-gray-50 dark:bg-gray-900  text-gray-800 dark:text-gray-100  mt-20 md:mt-18 lg:mt-0  h-full overflow-scroll">
      ...
      <div className=" bg-gray-50 dark:bg-gray-900 mt-3">
        <div className="lg:rounded-3xl md:border  border-gray-600 overflow-hidden">
